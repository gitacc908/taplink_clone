...
from .views import (
    GetNumber, VerifyCodeView, SignUpView,
...
urlpatterns = [
    # registration
    path('signup/get_number/', GetNumber.as_view(),
         name='get_number'),
    path('signup/verify/', VerifyCodeView.as_view(),
         name='verify_view'),
    path('signup/register/', SignUpView.as_view(),
         name='signup'),
